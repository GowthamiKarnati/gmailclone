...
//                     <span style={{ fontSize: "0.8w", marginLeft: "1.2vw", fontWeight: "500" }}>{data.sender}
//                     </span>
                ...
                .map((data) => (
                  <div key={data.id} onClick={() => handleEmailClick(data)}>
                    ...
                    >
                      <ListItem>
                        {data.starred ? (
                          <img src={yellow} style={{ cursor: 'pointer', width: '0.8vw', height: '0.8vw' }} />
                        ) : (
                          <img
                            onClick={() => starred(data)}
                            src={star}
                        ...
                        <span style={{ fontSize: '0.8w', marginLeft: '1.2vw', fontWeight: '500' }}>{data.sender}</span>
                        {showEmailDetail && (
                          <AccessTimeIcon
                            style={{ cursor: 'pointer', fontSize: '1.3vw', marginLeft: '1.8vw', marginBottom: '0.3vw', marginTop: '1vw' }}
