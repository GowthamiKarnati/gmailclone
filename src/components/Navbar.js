...
import menu from "../images/menu.png"; // Add the menu icon image import
            ...
            <Grid item xs={2}>
              <div style={{ display: "flex", alignItems: "center" }}>
                <IconButton edge="start" color="inherit" aria-label="menu" sx={{ mr: "0.8vw", color: "#3C3C3C" }}>
                  <img src={menu} style={{ width: "2vw", marginLeft: "2vw", cursor: "pointer" }} onClick={props.toggleLeftPanel} />
                </IconButton>
